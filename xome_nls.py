...
client = AzureOpenAI(
  ...
  api_key="5e9dd929597b422ebc90ed1d1d6eacdf",  
...
ELASTIC_PASSWORD = "Cobec-Tihi-Yomi-Ruvor" #"SHJGBRuDVsD1gaDIWe8fli20"
...
#CLOUD_ID = "suny:dXMtY2VudHJhbDEuZ2NwLmNsb3VkLmVzLmlvJDhiOWMyMjE5OTdhMDRmMjdhNzI0MWFkNzliOGI3MzJlJDc5OWM4M2VhZTA4MzRlNjQ4NTFjZGMzNzEzMWI0MTcx"

# Create the client instance
esclient = Elasticsearch(
    cloud_id=CLOUD_ID,
    basic_auth=("stephanraj.arokiasamy", ELASTIC_PASSWORD)
)
